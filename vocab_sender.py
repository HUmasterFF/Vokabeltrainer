...
# - Optional scheduling guard: only send at TARGET_HOURS in TZ (default Europe/Berlin)
#   Set TARGET_HOURS="9,15,21" and run hourly from GitHub Actions.
#   Use FORCE_SEND=1 to bypass the guard (for manual tests).
...
def send_twilio_whatsapp(text: str) -> None:
    # Requires a WhatsApp-enabled Twilio number or Sandbox in dev.
